...
bool handleOptions(int argc, char* const argv[]) {
    ...
    if (argc == 2 && strcmp(argv[1], "--xposedtestsafemode") == 0) {
        ...
        /**
         * xposed/xposed_safemode.cpp:176
         */
...
bool initialize(bool zygote, bool startSystemServer, const char* className, int argc, char* const argv[]) {
    ...
    /**
     * 添加/system/framework/XposedBridge.jar到CLASS_PATH中
     */
...
void printRomInfo() {
    ...
    ALOGI("SELinux enabled: %s, enforcing: %s",xposed->isSELinuxEnabled ? "yes" : "no", xposed->isSELinuxEnforcing ? "yes" : "no");
}
...
void parseXposedProp() {
	/**
	 * 解析文件
	 * xposed/xposed.h:6:  #define XPOSED_PROP_FILE "/system/xposed.prop"
	 */
...
bool isDisabled() {
  /**
	 * xposed/xposed_shared.h:22:#define XPOSED_DIR "/data/data/de.robv.android.xposed.installer/"
	 *
	 * xposed/xposed.h:17:#define XPOSED_LOAD_BLOCKER      XPOSED_DIR "conf/disabled"
	 *
	 * 判断【/data/data/de.robv.android.xposed.installer/conf/disabled】文件是否存在
	 */
...
void disableXposed() {
     ...
     * xposed/xposed.h:17:#define XPOSED_LOAD_BLOCKER      XPOSED_DIR "conf/disabled"
     *
     * 创建【/data/data/de.robv.android.xposed.installer/conf/disabled】文件，禁用xposed
     */
...
bool isSafemodeDisabled() {
	 ...
	 *
	 *xposed/xposed_shared.h:22:#define XPOSED_DIR "/data/data/de.robv.android.xposed.installer/"
	 *xposed/xposed.h:19:#define XPOSED_SAFEMODE_DISABLE  XPOSED_DIR "conf/safemode_disable"
	 *
	 *判断【/data/data/de.robv.android.xposed.installer/conf/safemode_disable】是否存在
	 *存在禁用安全模式，否则安全模式开启
	 */
...
bool shouldSkipSafemodeDelay() {
	 ...
	 * xposed/xposed_shared.h:22:#define XPOSED_DIR "/data/data/de.robv.android.xposed.installer/"
	 *
	 *xposed/xposed.h:18: #define XPOSED_SAFEMODE_NODELAY  XPOSED_DIR "conf/safemode_nodelay"
	 *
	 *判断【/data/data/de.robv.android.xposed.installer/conf/safemode_nodelay】是否存在
	 */
...
bool addJarToClasspath() {
    ...
    */
    ...
    /**
     * xposed/xposed.h:15:#define XPOSED_JAR               "/system/framework/XposedBridge.jar"
     *
     */
...
void onVmCreated(JNIEnv* env) {
    ...
    /**
     * xposed/libxposed_art.cpp:32
     *
     *	xposed/libxposed_dalvik.cpp:39
     *
     */
